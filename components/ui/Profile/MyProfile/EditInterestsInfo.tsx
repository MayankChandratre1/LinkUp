...
import { Address, DateOfBirth, Education, Gender, Height, Interests, Name } from '../../Registration/RegistrationForm';
import { CustomButton2 } from '../../CustomButton';
import { router } from 'expo-router';
import { updateUser } from '@/firebase/services/rnFirebase/db';

const EditInterestsInfo = ({close, userData}:{
  close: () => void,
...
export default EditInterestsInfo