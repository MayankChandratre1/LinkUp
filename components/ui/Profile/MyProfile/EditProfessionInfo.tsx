...
import { Address, DateOfBirth, Education, Gender, Height, Job, Name } from '../../Registration/RegistrationForm';
import { CustomButton2 } from '../../CustomButton';
import { router } from 'expo-router';
import { updateUser } from '@/firebase/services/rnFirebase/db';

const EditProfessionInfo = ({close, userData}:{
  close: () => void,
    ...
    // Save user data to database
      const res = await updateUser({
        user: {
          ...user,
          professionalInfo:{
            current_job: user.professionalInfo?.current_job || "",
          }
        },
      });
      close()
...
export default EditProfessionInfo